...
def test_computations():
    ...
    true_graph_conv_result_torch = torch.sparse.mm(adj_torch, dropout_result_torch)
    ...
    graph_conv_result_torch = torch.from_numpy(graph_conv_result)
    ...
    true_self_grads = dropout_result_torch.grad.numpy()
    ...
    ratio_equal = check_isclose(self_grads, true_neigh_grads)
